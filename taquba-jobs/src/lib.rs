...
//! short-circuiting to a cached result. Size the window so it covers
//! the longest gap callers need between the original submission and
//! an idempotent re-submit.
//!
//! # Time injection
//!
